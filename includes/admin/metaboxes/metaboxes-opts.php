	...
	<table class="form-table">
		...
		<tr valign="top">
			...
			<td id="source">
				...
				<p class="help"><?php echo site_url( $settings['goto_page'] ); ?>
					/<span><?php echo $opts['source_slug']; ?></span></p>
			</td>
		</tr>
					...
					<div class="geol_border">
						<table class="form-table">
							...
							<tr valign="top">
								...
								<td>
									<input type="text" class="widefat geol_options"
									       name="geol[dest][<?php echo $key; ?>][country]"
									       value="<?php echo esc_attr( $data['country'] ); ?>"
									       placeholder="<?php _e( 'Enter a country', 'geol' ); ?>"/>

									<input type="text" class="widefat geol_options"
									       name="geol[dest][<?php echo $key; ?>][state]"
									       value="<?php echo esc_attr( $data['state'] ); ?>"
									       placeholder="<?php _e( 'Enter a state', 'geol' ); ?>"/>

									<input type="text" class="widefat geol_options"
									       name="geol[dest][<?php echo $key; ?>][city]"
									       value="<?php echo esc_attr( $data['city'] ); ?>"
									       placeholder="<?php _e( 'Enter a city', 'geol' ); ?>"/>
								</td>
							</tr>
